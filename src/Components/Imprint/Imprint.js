...
function Imprint(props) {
    return <div className="imprint">
        <div className="imprint-container">
            <h1>Legal Disclosure | Imprint</h1>
            ...
            <p>Internet address: <a href="https://philjay.cc" target="_blank">https://philjay.cc</a></p>
            ...
            <p>Accountability for links</p>

            <p>Responsibility for the content of
            external links (to web pages of third parties) lies solely with the operators of the linked pages. No violations were
            evident to us at the time of linking. Should any legal infringement become known to us, we will remove the respective link immediately.</p>
            ...
            <p><a href="http://www.translate-24h.de" target="_blank">Source: translate-24h Übersetzungen</a></p>
